...
datos = datos |> 
  dplyr::select(TIPACCID, CLASE, ANIO, MES, DIA, HORA, MINUTOS, EDO, MPIO, SEXO, EDAD, CAUSAACCI, DIASEMANA, vehi_invol, TOTMUERTOS, TOTHERIDOS, CONDMUERTO, CONDHERIDO) |> 
  dplyr::mutate(
...
datos = datos |> 
  ...
  dplyr::select(TIPACCID, CLASE, ANIO, MES, DIA, HORA, MINUTOS, EDO, NOM_MUN, SEXO, EDAD, CAUSAACCI, DIASEMANA, vehi_invol, TOTMUERTOS, TOTHERIDOS, CONDMUERTO, CONDHERIDO) |>
